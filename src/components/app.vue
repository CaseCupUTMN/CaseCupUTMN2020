 ...
 <!-- Views/Tabs container -->
  <f7-views tabs class="safe-areas" theme-dark>
    ...
    <f7-toolbar tabbar labels bottom>
      <f7-link tab-link="#view-home" tab-link-active icon-ios="f7:person_crop_circle_badge_checkmark" icon-aurora="f7:person_crop_circle_badge_checkmark" icon-md="f7:person_crop_circle_badge_checkmark" text="Я участник"></f7-link>
